...
//         <div className={`navbar ${themeMode == 'light' ? 'bg-primary text-primary-content' : 'bg-transparent border-b-blue-300 border-b-2 '}`}>
        
//             <div className="flex-1">
//                 <Link to={shopiVerseNavigateLink} className="btn btn-ghost text-xl">ShopiVerse</Link>
//             </div>
...
//                 <div className='flex-10 navbar-center items-center justify-center space-x-5'>
//                    {buttons.map((button) => (
//                     <div key={button.text}>
//                         <Button classes={button.classes} text={button.text} onClick={button.onClick} />
//                     </div>
...
//                     <li>
//                     <Link to={UpdateProfileNavigate} className="justify-between">
//                         Profile
//                     </Link>
//                     </li>
//                     <li>
